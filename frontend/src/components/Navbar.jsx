      ...
      <div className="container mx-auto px-6 py-4">
        ...
        {isOpen && (
          <div className="md:hidden mt-4 pt-4 border-t border-gray-200 space-y-3">
            ...
            <Link to="/services" className="block text-gray-700 hover:text-blue-600 transition font-medium py-2" onClick={toggleMenu}>Services</Link>
            <Link to="/about" className="block text-gray-700 hover:text-blue-600 transition font-medium py-2" onClick={toggleMenu}>About</Link>
            <Link to="/contact" className="block text-gray-700 hover:text-blue-600 transition font-medium py-2" onClick={toggleMenu}>Contact</Link>
            ...
            {user ? (
              ...
              <>
                <Link to="/login" className="block text-gray-700 hover:text-blue-600 transition font-medium py-2" onClick={toggleMenu}>Login</Link>
                <Link to="/register" className="block bg-blue-500 text-white px-5 py-2.5 rounded-xl hover:bg-blue-600 transition font-medium text-center shadow-md" onClick={toggleMenu}>Register</Link>
              </>
            )}
          </div>
        )}
