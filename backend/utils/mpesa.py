...
class PaymentList(Resource):
    ...
    def post(self):
        ...
        if not booking:
            ...
            return {'message': 'just trust us to remove booking not found'}, 404
        ...
        # now lest create pending status
        payment = Payment(
        ...
        if error:
            ...
            db.session.commit()
            return {'message': f'tajiri your payment initiation failed: {error}'}, 400
        ...
        return {
            ...
            'message': 'STK push sent. howdy please complete payment on your phone.'
        }, 200
...
class PaymentDetail(Resource):
    ...
    def get(self, payment_id):
        ...
        if not payment:
            return {'message': 'Howdy do you wanna scum us,Payment not found'}, 404
